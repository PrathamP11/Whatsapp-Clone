  ...
  return (
    <div className="chat-header">
      ...
      <div className="chat-header-info">
        <div className="chat-header-name" title={displayName}>
          {displayName}
        </div>
      ...
      <div className="chat-header-actions">
        {/* Video Call */}
        <button className="icon-button" title="Video call" aria-label="Video call">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Voice Call */}
        <button className="icon-button" title="Voice call" aria-label="Voice call">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Search */}
        <button className="icon-button" title="Search messages" aria-label="Search messages">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
